...
std::unique_ptr<sla::RasterBase> PhrozenSonicMiniArchive::create_raster() const
{
...
sla::RasterEncoder PhrozenSonicMiniArchive::get_encoder() const { return sla::RasterEncoder{}; }

void PhrozenSonicMiniArchive::export_print(const std::string fname, const SLAPrint &print,
                                            const ThumbnailsList &thumbnails,
                                            const std::string    &projectname)
{
    // TODO: Implement Phrozen Sonic Mini 8K S PRZ format
}
