...
std::unique_ptr<sla::RasterBase> UniformationGKoneArchive::create_raster() const
{
...
sla::RasterEncoder UniformationGKoneArchive::get_encoder() const { return sla::RasterEncoder{}; }

void UniformationGKoneArchive::export_print(const std::string fname, const SLAPrint &print,
                                             const ThumbnailsList &thumbnails,
                                             const std::string    &projectname)
{
    // TODO: Implement Uniformation GKone JXS format
}
