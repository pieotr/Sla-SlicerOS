...
std::unique_ptr<sla::RasterBase> Emake3DGalaxyArchive::create_raster() const
{
...
sla::RasterEncoder Emake3DGalaxyArchive::get_encoder() const { return sla::RasterEncoder{}; }

void Emake3DGalaxyArchive::export_print(const std::string fname, const SLAPrint &print,
                                         const ThumbnailsList &thumbnails,
                                         const std::string    &projectname)
{
    // TODO: Implement Emake3D Galaxy QDT format (text-based vector lines)
}
