...
std::unique_ptr<sla::RasterBase> VoxeldanceTangoArchive::create_raster() const
{
...
sla::RasterEncoder VoxeldanceTangoArchive::get_encoder() const { return sla::RasterEncoder{}; }

void VoxeldanceTangoArchive::export_print(const std::string fname, const SLAPrint &print,
                                           const ThumbnailsList &thumbnails,
                                           const std::string    &projectname)
{
    // TODO: Implement Voxeldance Tango VDT format
}
